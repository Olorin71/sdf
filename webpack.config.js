...
const {Collect, MarkdownDependencyPlugin} = require('./markdown-collector');
const Pages = Collect();
...
module.exports = (env) => ({
	...
	"plugins": [...[
		new DefinePlugin({
			...
			'DefaultPath': JSON.stringify(Pages.find(page => page.isDefault).name)
		}),
		new MarkdownDependencyPlugin(),
